    ...
    public static void main(String[] args) {
        ...
        if (c != null) {
            ...
            try (Statement stmt = c.createStatement()) {
                ...
                // =====================
                System.out.println("\n--- Badges Table ---");
                ResultSet rs3 = stmt.executeQuery("SELECT * FROM badges");
                ...
                ResultSet rs4 = stmt.executeQuery("SELECT * FROM volunteer_badges");
                ...
                // ===========================
                System.out.println("\n--- Assignments Table ---");
                ResultSet rs5 = stmt.executeQuery("SELECT * FROM Assignment");
